...
const leftArrowButton = classNames(
  'position-absolute',
  'absolute-left-offset-10'
);

const leftArrow = classNames('pt-icon-large', 'pt-icon-double-chevron-left');

const rightArrowButton = classNames(
  'position-absolute',
  'absolute-right-offset-10'
);

const rightArrow = classNames('pt-icon-large', 'pt-icon-double-chevron-right');
